...
**0 min SMS**
> Hi {{contact.first_name}}, it's {{user.first_name}} with Elevated ID. {{opportunity.referral_office}} said you might reach out. Sorry about today, it happens more than you'd think. Grab 15 minutes here and we'll look at what's in the way: {{consult link}}. Reply STOP to opt out.
...
**Day 3 SMS**
> {{first_name}}, a lot of people put this off because they expect a lecture. It's not that. It's 15 minutes looking at the report together. {{consult link}}

**Day 8 SMS (close)**
> I'll stop reaching out. If you want to look at it later, this link works any time: {{consult link}}. Wishing you the best with the treatment.
...
> Good news: {{item or "your score"}} changed. You're at {{contact.current_credit_score}} (started at {{contact.starting_credit_score}}). Target is {{contact.target_credit_score}}. Next round goes out {{date}}.
